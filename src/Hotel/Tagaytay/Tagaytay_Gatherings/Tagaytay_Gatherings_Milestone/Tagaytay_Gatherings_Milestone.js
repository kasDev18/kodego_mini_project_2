...
import styles from './Tagaytay_Gatherings_Milestone.module.css';
import { Link } from 'react-router-dom';
import BookingForm from '../../../../components/BookingForm/BookingForm';
import ModalComponent from '../../../../components/ModalComponent/ModalComponentMilestone';

class TagaytayGatheringsMilestone extends React.Component {
  render() {
    return (
      <>
        <div className={styles.HotelBoracay}>
          <div className={styles.containerImage}>
            <img
              src="https://img.tagvenue.com/resize/cc/4e/widen-1680-noupsize;335-whole-venue-room.jpg"
              autoPlay
...
export default TagaytayGatheringsMilestone;
